...
void ShaderGeo::init(const std::string& vertFile, const std::string& fragFile, const std::string& geomFile)
{
...
void ShaderGeo::Update(const Transform& transform, const Camera& camera)
{
...
GLuint ShaderGeo::CreateShader(const std::string& text, unsigned int type)
{
...
std::string ShaderGeo::LoadShader(const std::string& fileName)
{
	std::ifstream file;
...
void ShaderGeo::CheckShaderError(GLuint shader, GLuint flag, bool isProgram, const std::string& errorMessage)
{
	GLint success = 0;
	GLchar error[1024] = { 0 };
