#include "MeshExplosion.h"
#include <vector>


void MeshExplosion::init(Vertex* vertices, unsigned int numVertices, unsigned int* indices, unsigned int numIndices)
{
	IndexedModel model;
...
void MeshExplosion::initModel(const IndexedModel& model)
{
...
void MeshExplosion::loadModel(const std::string& filename)
{
...
void MeshExplosion::updateSphereData(glm::vec3 pos, float radius)
{
